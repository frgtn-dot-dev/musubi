...
export type CalendarAdapter = {
  ...
  readMicrosoftRsvp?(user: string, account: string, calendar: string, ref: ExternalEventRef, response: import("@musubi/types").ProviderRsvpEdit["response"], signal?: AbortSignal, occurrence?: import("@musubi/types").GraphRsvpOccurrence): Promise<import("./adapters/microsoft_rsvp").MicrosoftRsvpEvidence>;
