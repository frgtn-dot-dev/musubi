...
for (const recurrence of ["FREQ=DAILY", "FREQ=DAILY;UNTIL=20260330T070000Z", "FREQ=DAILY;COUNT=367", "FREQ=WEEKLY;COUNT=106", "FREQ=YEARLY;COUNT=4", "FREQ=DAILY;COUNT=0"]) {
