...
| `GET /api/v1/public/events/:token/rsvp` | Read the verified-email guest's answer | 60 / 15 min / IP |
| `PUT /api/v1/public/events/:token/rsvp` | Write the verified-email guest's answer | 30 / 15 min / IP |
