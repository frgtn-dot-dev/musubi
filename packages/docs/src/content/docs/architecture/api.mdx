...
| Calendars | `GET/POST/PUT/DELETE /api/v1/calendars`, `GET /calendars/:id`, `/calendars/google`, `/calendars/tokens/:token`, `GET /calendars/:id/export` (.ics snapshot, any member) |
