...
**K10 explicitní časový edit — rozpracovaný balíček:** striktní úplný zoned/floating/all-day intent se převádí na konzistentní start/end/isAllDay/timeModel. Známá explicitní DST politika se nemění; kontroluje se výsledné pořadí instantů. Floating kompatibilní instants používají deterministicky UTC, nikdy ne odhad serverové zóny. All-day zachová inclusive konec. Samostatné procesy UTC/Prague/New_York ověřují kontrakt, mezery/fold, půlhodinový posun, původní civilní anchor a návaznost na shared expanzi. Následuje atomické CAS napojení, validace celé výsledné recurrence a outbound/DTO/editor kontrakt; tento čistý resolver dosud neaktivuje žádný writer.
