...
| K12 CalDAV | Osobní whole-resource series content/time/RRULE změna, occurrence content/time/cancel/revival, series/following delete a dvoukrokový following update | Známý zoned/floating/all-day model a úplná resource evidence; resource write, collection bind/unbind dle operace. Explicitní konflikt master content a obsahu existující aktivní výjimky je podporovaný; ostatní scope konflikty a širší časové/recurrence převody ještě nejsou implementované. [Kontrakt a Radicale důkazy](../sync/caldav-series-writes.md) |
