...
| K13 další zápisy | Organizer create/update/cancel s explicitní notification policy zůstávají implementační práce | Živé doručení vyžaduje samostatnou dvouúčtovou acceptance. |
