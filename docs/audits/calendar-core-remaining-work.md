...
| Identity a konkrétní invite/RSVP scénáře pro zbývající providery | Google one-off mezi dvěma schválenými účty je ověřené. Živé Outlook/iCloud a recurring scénáře vyžadují odpovídající připojení a vymezené testovací adresáty; samotné připojení není důkaz doručení. |
