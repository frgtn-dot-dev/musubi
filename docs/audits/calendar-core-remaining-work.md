...
| --- | --- |
| Další Outlook acceptance a conditional-write důkaz | Vývojové OAuth a one-off create/Accept/Tentative již prošly. Decline delivery, konečná recurring create a skutečný event conditional-write kontrakt zbývají; `changeKey` není CAS důkaz. [Aktuální evidence](calendar-outlook-live-acceptance-20260910.md). |
